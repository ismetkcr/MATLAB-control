...
%
x0  = [0 0 0 0 0 0 0 0 10 0 1 0 0 0 1 0 0 0 1 0 0 0];
...
%en_n = error_n;
%X = mu*v*error_n; Y = sqrt(mu^2 + v^2*error_n^2); en_n = X/Y;
...
if cikis_n_1<u_lower
    epsilon_n = epsilon_n_1 - sign(epsilon_n_1)*(u_lower - cikis_n_1);
elseif u_lower<=cikis_n_1 && cikis_n_1<=u_upper
    epsilon_n = epsilon_n_1 + en_n;
elseif cikis_n_1>u_upper
    epsilon_n = epsilon_n_1 - sign(epsilon_n_1)*(cikis_n_1 - u_upper);
end


fi_n_11 = en_n_2;
fi_n_12 = en_n_2*deltat;
fi_n_13 = (en_n_2 - en_n_3)/deltat;
...
C = en_n - cikis_hesap_n_2 + (fi_n_1*theta_n_1);
D = P_n*(fi_n_1)';

theta_n = theta_n_1 + (C*D);

%cikis_hesap =  fi_n*theta_n;
s_n = s_n_1 + (theta_n(1)/theta_n(2))*fi_n(2);
cikis_hesap_n = fi_n(1)*theta_n(1) + fi_n(3)*theta_n(3)*theta_n(1) + s_n;
...
state(19) = P_n(9);
state(20) = cikis_n_1;
state(21) = cikis_hesap_n;
state(22) = cikis_hesap_n_1;
