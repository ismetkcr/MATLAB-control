...
sizes.NumDiscStates  = 4;   %Ayarlanabilir degisken % X state sayýsý. Bunlara ait to zamaný baþlangýç degerlerini x0 vektoru ile ayarla.
...
%
x0  = [0 0 0 0];    %Ayarlanabilir degisken  % sizes.NumDiscStates sayýsý kadar deger girilmeli.
...
% bunu actarsam assagýdan state(3) silinmeli.
%}
