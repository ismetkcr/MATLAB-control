...
%  This M-file reads the temperature input channels from the SL 8018 with 8520
...
s = 0;
mport = 0;
num_tempCHN = AC1 + AC2 + AC3 + AC4 + AC5 + AC6 + AC7 + AC8; 

sizes = simsizes;
sizes.NumContStates  = 0;
sizes.NumDiscStates  = 0;
sizes.NumOutputs     = num_tempCHN;
sizes.NumInputs      = 1;  
